...
class ClickHouseStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteQuery = channel.unary_unary(
                '/datastore.grpc.Datastore/ExecuteQuery',
        ...
        self.ExecuteQueryWithStreamInput = channel.stream_unary(
                '/datastore.grpc.Datastore/ExecuteQueryWithStreamInput',
                request_serializer=clickhouse__grpc__pb2.QueryInfo.SerializeToString,
                response_deserializer=clickhouse__grpc__pb2.Result.FromString,
                )
        self.ExecuteQueryWithStreamOutput = channel.unary_stream(
                '/datastore.grpc.Datastore/ExecuteQueryWithStreamOutput',
                request_serializer=clickhouse__grpc__pb2.QueryInfo.SerializeToString,
                response_deserializer=clickhouse__grpc__pb2.Result.FromString,
                )
        self.ExecuteQueryWithStreamIO = channel.stream_stream(
                '/datastore.grpc.Datastore/ExecuteQueryWithStreamIO',
                request_serializer=clickhouse__grpc__pb2.QueryInfo.SerializeToString,
                response_deserializer=clickhouse__grpc__pb2.Result.FromString,
                )
...
def add_ClickHouseServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'datastore.grpc.Datastore', rpc_method_handlers)
...
class Datastore(object):
    ...
    def ExecuteQuery(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/datastore.grpc.Datastore/ExecuteQuery',
    ...
    def ExecuteQueryWithStreamInput(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/datastore.grpc.Datastore/ExecuteQueryWithStreamInput',
            clickhouse__grpc__pb2.QueryInfo.SerializeToString,
            clickhouse__grpc__pb2.Result.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ExecuteQueryWithStreamOutput(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/datastore.grpc.Datastore/ExecuteQueryWithStreamOutput',
            clickhouse__grpc__pb2.QueryInfo.SerializeToString,
            clickhouse__grpc__pb2.Result.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ExecuteQueryWithStreamIO(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/datastore.grpc.Datastore/ExecuteQueryWithStreamIO',
            clickhouse__grpc__pb2.QueryInfo.SerializeToString,
            clickhouse__grpc__pb2.Result.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
