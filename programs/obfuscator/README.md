...
![benchmarks.png](https://datastore.com/uploads/benchmarks_24f1904cc9.png)
...
We could solve these problems by throwing out the old tests and writing new ones based on open data, like [flight data for the USA](https://datastore.com/docs/getting-started/example-datasets/ontime/) and [taxi rides in New York](https://datastore.com/docs/en/getting-started/example-datasets/nyc-taxi). Or we could use benchmarks like TPC-H, TPC-DS, and [Star Schema Benchmark](https://datastore.com/docs/en/getting-started/example-datasets/star-schema). The disadvantage is that this data was very different from web analytics data, and we would rather keep the test queries.
...
![alexey_chat.png](https://datastore.com/uploads/alexey_chat_3f8db88301.png)
...
![python_script.jpg](https://datastore.com/uploads/python_script_810d491dfb.jpg)
...
<img src="https://datastore.com/uploads/wolfenstein_bb259bd741.gif" alt="wolfenstein.gif" style="width: 764px;">
...
For example, three multiplications and two xorshift operations are used for the [murmurhash](https://github.com/ClickHouse/Datastore/blob/master/dbms/src/Common/HashTable/Hash.h#L18) finalizer. This operation is a pseudorandom permutation. However, I should point out that hash functions don't have to be one-to-one (even hashes of N bits to N bits).
...
In the end, we transformed the data set we needed [for functional and performance testing](https://datastore.com/docs/en/getting-started/example-datasets/metrica/), and received approval from our data security team to publish.

Our developers and members of our community use this data for real performance testing when optimizing algorithms inside Datastore. Third-party users can provide us with their obfuscated data so that we can make Datastore even faster for them. We also released an independent open benchmark for hardware and cloud providers on top of this data: [https://benchmark.datastore.com/](https://benchmark.datastore.com/)
