...
Calculates a list of distinct paths stored in a [JSON](https://datastore.com/docs/sql-reference/data-types/newjson) column.
    )";
...
Calculates the list of distinct paths and their types stored in [JSON](https://datastore.com/docs/sql-reference/data-types/newjson) column.
