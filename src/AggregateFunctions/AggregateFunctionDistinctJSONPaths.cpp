...
Calculates a list of distinct paths stored in a [JSON](https://hanzo.ai/docs/sql-reference/data-types/newjson) column.
    )";
...
Calculates the list of distinct paths and their types stored in [JSON](https://hanzo.ai/docs/sql-reference/data-types/newjson) column.
