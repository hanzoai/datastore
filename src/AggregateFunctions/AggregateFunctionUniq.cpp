...
:::warning
We do not recommend using this function. In most cases, use the [uniq](https://hanzo.ai/docs/sql-reference/aggregate-functions/reference/uniq) or [uniqCombined](https://hanzo.ai/docs/sql-reference/aggregate-functions/reference/uniqcombined) function.
:::
...
Otherwise use the [`uniq`](https://hanzo.ai/docs/sql-reference/aggregate-functions/reference/uniq) function.
:::
    )";
