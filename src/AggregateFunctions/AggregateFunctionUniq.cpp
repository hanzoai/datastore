...
:::warning
We do not recommend using this function. In most cases, use the [uniq](https://datastore.com/docs/sql-reference/aggregate-functions/reference/uniq) or [uniqCombined](https://datastore.com/docs/sql-reference/aggregate-functions/reference/uniqcombined) function.
:::
...
Otherwise use the [`uniq`](https://datastore.com/docs/sql-reference/aggregate-functions/reference/uniq) function.
:::
    )";
