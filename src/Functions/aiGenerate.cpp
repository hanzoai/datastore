...
not set, the default is: `)" + String(default_system_prompt) + R"(`
        ...
        = {{"Simple question", "SELECT aiGenerate('What is 2 + 2? Reply with just the number.')", "4"},
           {"With explicit credentials and system prompt", "SELECT aiGenerate('Explain Datastore', map('credentials', 'ai_text_credentials', 'system_prompt', 'You are a database expert. Be concise.'))", ""},
