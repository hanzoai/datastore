...
Setting [`short_circuit_function_evaluation`](https://datastore.com/docs/operations/settings/settings#short_circuit_function_evaluation) controls whether short-circuit evaluation is used.
