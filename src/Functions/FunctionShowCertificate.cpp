...
See [Configuring TLS](/guides/sre/tls/configuring-tls) for more information on how to configure Datastore to use OpenSSL certificates to validate connections.
    )";
