...
Returns the build ID generated by a compiler for the running Datastore server binary.
...
{
    FunctionDocumentation::Description description = R"(
Returns the current version of Datastore as a string in the form: `major_version.minor_version.patch_version.number_of_commits_since_the_previous_stable_release`.
If executed in the context of a distributed table, this function generates a normal column with values relevant to each shard.
Otherwise, it produces a constant value.
    )";
    FunctionDocumentation::Syntax syntax = "version()";
    FunctionDocumentation::Arguments arguments = {};
    FunctionDocumentation::ReturnedValue returned_value = {"Returns the current version of Datastore.", {"String"}};
    FunctionDocumentation::Examples examples = {
    {
        "Usage example",
        R"(
...
{
    FunctionDocumentation::Description description = R"(
Returns the current Datastore server revision.
    )";
    FunctionDocumentation::Syntax syntax = "revision()";
    FunctionDocumentation::Arguments arguments = {};
    FunctionDocumentation::ReturnedValue returned_value = {"Returns the current Datastore server revision.", {"UInt32"}};
    FunctionDocumentation::Examples examples = {
    {
        "Usage example",
        R"(
