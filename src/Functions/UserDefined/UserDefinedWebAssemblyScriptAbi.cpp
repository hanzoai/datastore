...
/// exposes `String` and primitive types to Datastore.
///
...
/// `RowDirect` (with Int8/UInt8/Int16/UInt16 widened to i32). Datastore `String`
...
public:
    ...
    /// Map a Datastore data type to the WASM kind used to pass it across the AS boundary.
