...
/// per row, mapping Datastore `String` values to AssemblyScript `String` objects (rtId = 2,
/// UTF-16 payload, 20-byte object header) via the runtime exports `__new` / `__pin` / `__unpin`,
/// and Datastore numeric types to AssemblyScript primitives (i32 / i64 / f32 / f64) the same
