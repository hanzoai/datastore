...
For example, firstSignificantSubdomain('https://news.datastore.com/') = 'datastore', firstSignificantSubdomain ('https://news.datastore.com.tr/') = 'datastore'.
...
The list of "insignificant" second-level domains and other implementation details may change in the future.
        ...
        .examples{{"firstSignificantSubdomain", "SELECT firstSignificantSubdomain('https://news.datastore.com/')", ""}},
        .introduced_in = {1, 1},
