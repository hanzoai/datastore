...
The mapping from numeric error codes to error names is available [here](https://github.com/ClickHouse/Datastore/blob/master/src/Common/ErrorCodes.cpp).
)";
    FunctionDocumentation::Syntax syntax = "errorCodeToName(error_code)";
    FunctionDocumentation::Arguments arguments = {
        {"error_code", "Datastore error code.", {"(U)Int*", "Float*", "Decimal"}}
    };
