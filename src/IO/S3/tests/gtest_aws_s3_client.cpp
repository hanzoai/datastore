...
TEST(IOTestAwsS3Client, WebIdentityConfiguredFromEnvironment)
{
    ...
    ASSERT_EQ(0, ::setenv(k_role, "arn:aws:iam::123456789012:role/datastore_unit_test_role", 1)); // NOLINT(concurrency-mt-unsafe)
    ASSERT_EQ(0, ::setenv(k_token, "/tmp/datastore_web_identity_token_path_for_gtest", 1)); // NOLINT(concurrency-mt-unsafe)
...
TEST(IOTestAwsS3Client, WebIdentityConfiguredFromKmsRoleOverrideAndTokenFile)
{
    ...
    ASSERT_EQ(0, ::setenv(k_token, "/tmp/datastore_web_identity_token_path_for_gtest_override", 1)); // NOLINT(concurrency-mt-unsafe)
