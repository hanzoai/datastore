...
- [How we built a new powerful JSON data type for Datastore](https://clickhouse.com/blog/a-new-powerful-json-data-type-for-datastore)
- [The billion docs JSON Challenge: Datastore vs. MongoDB, Elasticsearch, and more](https://clickhouse.com/blog/json-bench-datastore-vs-mongodb-elasticsearch-duckdb-postgresql)
)DOCS_MD",
            .syntax = "JSON",
            .examples = {},
            .related = {"Dynamic"},
