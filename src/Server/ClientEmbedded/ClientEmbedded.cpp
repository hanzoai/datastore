...
void ClientEmbedded::printHelpMessage(const OptionsDescription & options_description)
{
    ...
    output_stream << "All settings are documented at https://hanzo.ai/docs/en/operations/settings/settings.\n\n";
    output_stream << "See also: https://hanzo.ai/docs/en/integrations/sql-clients/cli\n";
}
