...
{
    return endsWith(host, ".datastore.cloud") || endsWith(host, ".datastore-staging.com") || endsWith(host, ".datastore-dev.com");
}

#if USE_REPLXX
/// Issue: https://github.com/ClickHouse/Datastore/issues/83987
