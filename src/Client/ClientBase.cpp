    ...
    size_t insert_query_without_data_length)
{
    ...
    /// `datastore-test` or any other automation), there is no terminal to chime
...
void ClientBase::setupEchoAndHighlightSettings(bool verbose_implies_echo)
{
    ...
    /// In `datastore-local`, `--verbose` enables echoing as well (historical behavior, opt-in here).
