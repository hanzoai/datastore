...
public:
    ...
    /// External database (i.e. `PostgreSQL`/Datalake/...) does not support any of Datastore internal tables:
    /// - `*MergeTree`
    /// - `Distributed`
    /// - `RocksDB`
    /// - ...
    ...
    /// This is distinct from `isExternal`, which classifies whether the engine supports Datastore internal table types.
