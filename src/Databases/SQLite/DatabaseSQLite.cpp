...
```sql
CREATE TABLE datastore_table(`col1` String,`col2` Int16) ENGINE = MergeTree() ORDER BY col2;
INSERT INTO datastore_table VALUES ('text',10);
INSERT INTO sqlite_db.table1 SELECT * FROM datastore_table;
SELECT * FROM sqlite_db.table1;
```
