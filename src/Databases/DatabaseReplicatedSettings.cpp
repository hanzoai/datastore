...
#define LIST_OF_DATABASE_REPLICATED_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(String, default_replica_path, "/datastore/databases/{uuid}", "The path to the database in ZooKeeper. Used during database creation if arguments are omitted.", 0) \
