...
The table below shows supported data types and how they match Datastore [data types](/reference/data-types/index) in `INSERT` and `SELECT` queries.
...
In this case, Datastore will autogenerate CapnProto schema according to the table structure using function [structureToCapnProtoSchema](/reference/functions/regular-functions/other-functions#structureToCapnProtoSchema) and will use this schema to serialize data in CapnProto format.
