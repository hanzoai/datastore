...
<Note>
Both specifications were generated by LLMs from the Datastore source code. The code remains the main source of truth: where the specification and the code disagree, the code is correct.
</Note>
