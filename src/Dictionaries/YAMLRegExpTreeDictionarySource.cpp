...
void registerDictionarySourceYAMLRegExpTree(DictionarySourceFactory & factory)
{
                                   ...
                                   [[maybe_unused]] bool created_from_ddl) -> DictionarySourcePtr
    {
        ...
        throw Exception(
            ...
            "Dictionary source of type `{}` is disabled because Datastore was built without yaml_cpp support",
            kYAMLRegExpTree);
#endif
    };
...
#if !USE_YAML_CPP
            " Currently unavailable, because this Datastore build does not include YAML support."
#endif
        ,
