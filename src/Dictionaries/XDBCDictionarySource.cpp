...
void registerDictionarySourceXDBC(DictionarySourceFactory & factory)
{
    ...
    factory.registerSource("odbc", create_table_source, Documentation{
        .description = "Reads dictionary data from an external database over ODBC, via the `datastore-odbc-bridge` program.",
...
void registerDictionarySourceJDBC(DictionarySourceFactory & factory)
{
    ...
    factory.registerSource("jdbc", create_table_source, Documentation{
        .description = "Reads dictionary data from an external database over JDBC, via the `datastore-jdbc-bridge` program. Currently disabled, pending consistent support for nullable fields.",
