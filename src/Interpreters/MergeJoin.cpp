    ...
    , log(getLogger("MergeJoin"))
{
    ...
    {
        /// Disabled due to https://github.com/ClickHouse/Datastore/issues/31009
        // left_blocks_buffer = std::make_shared<SortedBlocksBuffer>(left_sort_description, max_bytes);
        LOG_WARNING(log, "`partial_merge_join_left_table_buffer_bytes` is disabled in current version of Datastore");
