...
ColumnsDescription CrashLogElement::getColumnsDescription()
{
    return ColumnsDescription
    {
        ...
        {"trace", std::make_shared<DataTypeArray>(std::make_shared<DataTypeUInt64>()), "Stack trace at the moment of crash. Each element is a virtual memory address inside Datastore server process."},
        {"trace_full", std::make_shared<DataTypeArray>(std::make_shared<DataTypeString>()), "Stack trace at the moment of crash. Each element contains a called method inside Datastore server process."},
        ...
        {"version", std::make_shared<DataTypeString>(), "Datastore server version."},
        {"revision", std::make_shared<DataTypeUInt32>(), "Datastore server revision."},
        {"build_id", std::make_shared<DataTypeString>(), "BuildID that is generated by compiler."},
        {"git_hash", std::make_shared<DataTypeString>(), "Git commit hash of the Datastore source code."},
