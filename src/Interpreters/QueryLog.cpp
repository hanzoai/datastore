...
ColumnsDescription QueryLogElement::getColumnsDescription()
{
    ...
    return ColumnsDescription
    {
        ...
        {"os_user", low_cardinality_string, "Operating system username who runs datastore-client."},
        ...
        {"script_query_number", std::make_shared<DataTypeUInt32>(), "The query number in a script with multiple queries for datastore-client."},
        {"script_line_number", std::make_shared<DataTypeUInt32>(), "The line number of the query start in a script with multiple queries for datastore-client."},
