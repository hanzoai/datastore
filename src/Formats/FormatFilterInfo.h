...
{
public:
    /// datastore_column_name -> field_id
    ...
    const std::unordered_map<Int64, String> & getFieldIdToDatastoreName() const { return field_id_to_datastore_name; }

    /// datastore_column_name -> format_column_name (just join the maps above by field_id).
...
private:
    ...
    std::unordered_map<Int64, String> field_id_to_datastore_name;
};
