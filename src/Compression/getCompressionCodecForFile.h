...
/// datastore fashion (with checksums, headers for each block, etc). This
...
/// Same as above which is used by datastore-compressor to print compression statistics of each data block.
CompressionCodecPtr
