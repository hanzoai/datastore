...
static void callback(void * arg, int status, int, struct hostent * host)
{
    if (status == ARES_SUCCESS)
    {
        ...
        /*
             ...
             * https://github.com/ClickHouse/Datastore/issues/40595#issuecomment-1230526931
             * */
...
CaresPTRResolver::CaresPTRResolver(CaresPTRResolver::provider_token)
{
    /*
         ...
         * to grpc. As discussed in https://github.com/ClickHouse/Datastore/pull/37827#discussion_r919189085, c-ares should be adapted to be atomic
         *
