...
```
    ...
    DECLARE(String, dynamic_user_defined_executable_functions_path, "/var/lib/datastore/dynamic_user_defined_executable_functions/", R"(
...
```xml
<dynamic_user_defined_executable_functions_path>/var/lib/datastore/dynamic_user_defined_executable_functions/</dynamic_user_defined_executable_functions_path>
```
)", 0) \
