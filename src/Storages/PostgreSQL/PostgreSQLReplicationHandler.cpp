...
PostgreSQLReplicationHandler::PostgreSQLReplicationHandler(
    ...
    , replication_slot(getReplicationSlotName(postgres_database_, postgres_schema, postgres_table_, datastore_uuid_, replication_settings))
    ...
    , legacy_replication_slot(getReplicationSlotName(postgres_database_, /* postgres_schema */ "", postgres_table_, datastore_uuid_, replication_settings))
