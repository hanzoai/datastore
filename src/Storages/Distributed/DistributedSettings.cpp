...
#define LIST_OF_DISTRIBUTED_SETTINGS(DECLARE, DECLARE_WITH_ALIAS) \
    ...
    DECLARE(Bool, skip_unavailable_shards, false, "If true, Datastore silently skips unavailable shards. The behavior of this setting is controlled by the `skip_unavailable_shards_mode` parameter.", 0) \
