...
public:
    ...
    virtual std::string getFullPath() const = 0;         /// '/var/lib/datastore/data/database/table/moving/all_1_5_1'
    ...
    virtual std::string getFullRootPath() const = 0;     /// '/var/lib/datastore/data/database/table/moving'
