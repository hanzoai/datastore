...
/// Datastore `CacheBase` so that all memory accounting flows through
...
public:
    ...
    const char * Name() const override { return "DatastoreUniqueKeyIndexCache"; }
