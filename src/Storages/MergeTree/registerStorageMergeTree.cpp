...
See details in documentation: https://datastore.com/docs/engines/table-engines/mergetree-family/mergetree/. Other engines of the family support different syntax, see details in the corresponding documentation topics.

If you use the Replicated version of engines, see https://datastore.com/docs/engines/table-engines/mergetree-family/replication/.
)";
