...
To implement the JDBC connection, Datastore uses the separate program [datastore-jdbc-bridge](https://github.com/Datastore/datastore-jdbc-bridge) that should run as a daemon.
