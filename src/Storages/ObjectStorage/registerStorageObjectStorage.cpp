...
In Datastore the behavior is consistent with Spark. You can mentally replace Spark Select queries with Datastore Select queries and it will work the same way.
