...
/// or may be absolute paths (/table/data/xxx.parquet) if written from Datastore.
///
...
/// produced by Datastore by table_location traversal or taken from the corresponding Iceberg Catalog. In case metadata.json
/// is generated by Datastore it will be expressed by this type.
