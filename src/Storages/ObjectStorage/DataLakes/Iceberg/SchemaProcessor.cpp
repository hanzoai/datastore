...
std::shared_ptr<NamesAndTypesList> IcebergSchemaProcessor::getDatastoreTableSchemaById(Int32 id)
{
    SharedLockGuard lock(mutex);
...
bool IcebergSchemaProcessor::hasDatastoreTableSchemaById(Int32 id) const
{
    SharedLockGuard lock(mutex);
