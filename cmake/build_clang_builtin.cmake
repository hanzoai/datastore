...
function (build_clang_builtin target_triple OUT_VARIABLE)
    ...
    elseif (target_triple STREQUAL "aarch64-unknown-freebsd13")
        set (BUILTINS_TOOLCHAIN_FILE "${Datastore_SOURCE_DIR}/cmake/freebsd/toolchain-aarch64.cmake")
    ...
    elseif (target_triple STREQUAL "powerpc64le-unknown-freebsd13")
        set (BUILTINS_TOOLCHAIN_FILE "${Datastore_SOURCE_DIR}/cmake/freebsd/toolchain-ppc64le.cmake")
        set (BUILTINS_TARGET "lib/freebsd/libclang_rt.builtins-powerpc64le.a")
    elseif (target_triple STREQUAL "x86_64-pc-freebsd13")
        set (BUILTINS_TOOLCHAIN_FILE "${Datastore_SOURCE_DIR}/cmake/freebsd/toolchain-x86_64.cmake")
    ...
    set (BUILTINS_SOURCE_DIR "${Datastore_SOURCE_DIR}/contrib/llvm-project/compiler-rt")
    set (BUILTINS_BINARY_DIR "${Datastore_BINARY_DIR}/clang-builtins")
