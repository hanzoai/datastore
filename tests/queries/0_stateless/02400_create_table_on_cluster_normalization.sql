...
create table local_t_l5ydey on cluster test_shard_localhost (
    ...
    c_m3 TEXT NOT NULL,
    primary key(c_qv5rv)
) engine=ReplicatedMergeTree('/datastore/tables/test_' || currentDatabase() || '/{shard}/local_t_l5ydey', '{replica}');
...
create database local_t_l5ydey engine=Replicated('/datastore/tables/test_' || currentDatabase() || '/{shard}/local_t_l5ydey', '1', '1'); -- { serverError BAD_ARGUMENTS }
