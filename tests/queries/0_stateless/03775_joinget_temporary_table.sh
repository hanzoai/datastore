...
$DATASTORE_CLIENT -q "DROP TABLE IF EXISTS 03775_join, 03775_data"
...
$DATASTORE_CLIENT -nm -q "
    ...
    SELECT joinGet('$DATASTORE_DATABASE.03775_join', 'val', 1::UInt32);
    SELECT joinGet('$DATASTORE_DATABASE.03775_join', 'val', 2::UInt32);
    SELECT joinGet($DATASTORE_DATABASE.03775_join, 'val', 3::UInt32);
    SELECT joinGet($DATASTORE_DATABASE.03775_join, 'val', 4::UInt32);

    SELECT '----';
    SELECT key, joinGet('$DATASTORE_DATABASE.03775_join', 'val', key) FROM 03775_data ORDER BY 1;
"
...
$DATASTORE_CLIENT -q "SELECT joinGet('03775_fake_table', 'val', 123) -- { serverError UNKNOWN_TABLE }"
$DATASTORE_CLIENT -nm -q "
...
$DATASTORE_CLIENT -q "DROP TABLE 03775_join, 03775_data;"
