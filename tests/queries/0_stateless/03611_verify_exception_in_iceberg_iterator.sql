...
SELECT * FROM icebergS3('http://localhost:11111/test/corrupted_avro_files_test/', 'datastore', 'datastore') SETTINGS use_iceberg_metadata_files_cache = False; -- { serverError INCORRECT_DATA}