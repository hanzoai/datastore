...
DESCRIBE (SELECT test_table.id, test_table.value FROM {DATASTORE_DATABASE_1:Identifier}.test_table);
SELECT test_table.id, test_table.value FROM {DATASTORE_DATABASE_1:Identifier}.test_table;

SELECT '--';

DESCRIBE (SELECT {DATASTORE_DATABASE_1:Identifier}.test_table.id, {DATASTORE_DATABASE_1:Identifier}.test_table.value FROM {DATASTORE_DATABASE_1:Identifier}.test_table);
SELECT {DATASTORE_DATABASE_1:Identifier}.test_table.id, {DATASTORE_DATABASE_1:Identifier}.test_table.value FROM {DATASTORE_DATABASE_1:Identifier}.test_table;

SELECT '--';

DESCRIBE (SELECT test_table.id, test_table.value FROM {DATASTORE_DATABASE_1:Identifier}.test_table AS test_table);
SELECT test_table.id, test_table.value FROM {DATASTORE_DATABASE_1:Identifier}.test_table AS test_table;
