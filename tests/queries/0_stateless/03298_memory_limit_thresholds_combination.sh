...
$DATASTORE_CLIENT -q 'DROP USER IF EXISTS u03298'
$DATASTORE_CLIENT -q 'CREATE USER IF NOT EXISTS u03298 IDENTIFIED WITH no_password'
$DATASTORE_CLIENT -q 'GRANT ALL ON *.* TO u03298'

echo "[Aggregation] -- Big Ratio"
$DATASTORE_CLIENT -u u03298 -q "
