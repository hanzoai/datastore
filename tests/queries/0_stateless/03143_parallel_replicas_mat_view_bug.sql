...
CREATE MATERIALIZED VIEW mv_table (str String) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/03143_parallel_replicas_mat_view_bug', '{replica}') ORDER BY str AS SELECT str AS str FROM null_table;
