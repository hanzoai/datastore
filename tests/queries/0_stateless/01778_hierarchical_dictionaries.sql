...
CREATE TABLE {DATASTORE_DATABASE_1:Identifier}.hierarchy_source_table (id UInt64, parent_id UInt64) ENGINE = TinyLog;
INSERT INTO {DATASTORE_DATABASE_1:Identifier}.hierarchy_source_table VALUES (1, 0), (2, 1), (3, 1), (4, 2);

CREATE DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_flat_dictionary
(
    id UInt64,
    parent_id UInt64 HIERARCHICAL
)
PRIMARY KEY id
SOURCE(DATASTORE(HOST 'localhost' PORT tcpPort() USER 'default' TABLE 'hierarchy_source_table' DB currentDatabase()))
LAYOUT(FLAT())
...
DROP DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_flat_dictionary;

CREATE DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_hashed_dictionary
(
    id UInt64,
    parent_id UInt64 HIERARCHICAL
)
...
DROP DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_hashed_dictionary;

CREATE DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_cache_dictionary
(
    id UInt64,
    parent_id UInt64 HIERARCHICAL
)
...
DROP DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_cache_dictionary;

CREATE DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_direct_dictionary
(
    id UInt64,
    parent_id UInt64 HIERARCHICAL
)
...
DROP DICTIONARY {DATASTORE_DATABASE_1:Identifier}.hierarchy_direct_dictionary;

DROP TABLE {DATASTORE_DATABASE_1:Identifier}.hierarchy_source_table;
