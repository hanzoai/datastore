...
DROP DICTIONARY IF EXISTS {DATASTORE_DATABASE_1:Identifier}.cache_hits;

CREATE DICTIONARY {DATASTORE_DATABASE_1:Identifier}.cache_hits
(WatchID UInt64, UserID UInt64, SearchPhrase String)
PRIMARY KEY WatchID
SOURCE(DATASTORE(HOST 'localhost' PORT tcpPort() USER 'default' TABLE 'hits_1m' PASSWORD '' DB 'test'))
