...
CREATE TABLE zero_rows_per_granule1 (
  ...
  v1 UInt64,
  v2 Int64
) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00926/zero_rows_in_granule', '1') PARTITION BY toYYYYMM(p) ORDER BY k SETTINGS index_granularity_bytes = 20, min_index_granularity_bytes = 10, write_final_mark = 0;
...
CREATE TABLE zero_rows_per_granule2 (
  ...
  v1 UInt64,
  v2 Int64
) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00926/zero_rows_in_granule', '2') PARTITION BY toYYYYMM(p) ORDER BY k SETTINGS index_granularity_bytes = 20, min_index_granularity_bytes = 10, write_final_mark = 0;
...
CREATE TABLE four_rows_per_granule1 (
  ...
  v1 UInt64,
  v2 Int64
) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00926/four_rows_in_granule', '1') PARTITION BY toYYYYMM(p) ORDER BY k SETTINGS index_granularity_bytes = 110, min_index_granularity_bytes = 100, write_final_mark = 0;
...
CREATE TABLE four_rows_per_granule2 (
  ...
  v1 UInt64,
  v2 Int64
) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00926/four_rows_in_granule', '2') PARTITION BY toYYYYMM(p) ORDER BY k SETTINGS index_granularity_bytes = 110, min_index_granularity_bytes = 100 ,write_final_mark = 0;
...
CREATE TABLE adaptive_granularity_alter1 (
  ...
  v1 UInt64,
  v2 Int64
) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00926/adaptive_granularity_alter', '1') PARTITION BY toYYYYMM(p) ORDER BY k SETTINGS index_granularity_bytes = 110, min_index_granularity_bytes = 100, write_final_mark = 0;
...
CREATE TABLE adaptive_granularity_alter2 (
  ...
  v1 UInt64,
  v2 Int64
) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00926/adaptive_granularity_alter', '2') PARTITION BY toYYYYMM(p) ORDER BY k SETTINGS index_granularity_bytes = 110, min_index_granularity_bytes = 100, write_final_mark = 0;
