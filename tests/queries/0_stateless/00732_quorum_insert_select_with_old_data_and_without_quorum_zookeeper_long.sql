...
CREATE TABLE quorum1(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00732/quorum_old_data', '1') ORDER BY x PARTITION BY y;
CREATE TABLE quorum2(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00732/quorum_old_data', '2') ORDER BY x PARTITION BY y;
