...
ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_01062/alter_on_mutation', '1')
...
CREATE TABLE nested_alter (`d` Date, `k` UInt64, `i32` Int32, `dt` DateTime, `n.ui8` Array(UInt8), `n.s` Array(String), `n.d` Array(Date), `s` String DEFAULT '0') ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_01062/nested_alter', 'r2', d, k, 8192);
