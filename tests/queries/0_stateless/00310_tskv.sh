...
$DATASTORE_CLIENT --query="CREATE TABLE tskv (tskv_format String, timestamp DateTime('UTC'), timezone String, text String, binary_data String) ENGINE = Memory";
...
$DATASTORE_CLIENT --query="SELECT * FROM tskv ORDER BY binary_data";
