...
while [[ $i -lt $retries ]]; do
    timeout 10 ${DATASTORE_CLIENT} --max_threads 1 --max_distributed_connections 10 --query "
...
timeout 1 ${DATASTORE_CLIENT} --max_threads 1 --max_distributed_connections 1 --async_socket_for_remote 0 --query "
