...
${DATASTORE_CLIENT} --query "drop table if exists test_s3_mt"
...
${DATASTORE_CLIENT} --query "optimize table test_s3_mt final"
...
${DATASTORE_CLIENT} --query "drop table if exists test_s3_mt_dst"
...
${DATASTORE_CLIENT} --query "drop table test_s3_mt sync"
