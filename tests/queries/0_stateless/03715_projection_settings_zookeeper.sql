...
CREATE TABLE x1 (i int) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/x', 'r1') ORDER BY i SETTINGS index_granularity = 999999999, index_granularity_bytes = 99999999999, use_const_adaptive_granularity = 0, min_bytes_for_wide_part = 0;

CREATE TABLE x2 (i int) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/x', 'r2') ORDER BY i SETTINGS index_granularity = 999999999, index_granularity_bytes = 99999999999, use_const_adaptive_granularity = 0, min_bytes_for_wide_part = 0;
