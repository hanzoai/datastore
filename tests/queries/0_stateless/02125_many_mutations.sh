...
job()
{
   yes "alter table many_mutations update y = y + 1 where 1;" | head -n 1000 | $DATASTORE_CLIENT --max_execution_time 120 --lock_acquire_timeout 120
}
...
$DATASTORE_CLIENT --max_execution_time 120 -q "
