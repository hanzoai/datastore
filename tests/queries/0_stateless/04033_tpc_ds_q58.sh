...
# Known issue: the original query doesn't work, uses alternative formulation (https://github.com/ClickHouse/Datastore/issues/94976).
...
{ echo "USE tpcds;"; cat "$CURDIR/../../benchmarks/tpc-ds/queries/query_58.sql"; } | $DATASTORE_CLIENT "${SETTINGS[@]}"
