...
$DATASTORE_CLIENT --query="INSERT INTO points FORMAT TSV" --min_chunk_bytes_for_parallel_parsing=10485760 --max_insert_block_size=100000 < "${DATA_DIR}/01037_point_data"
...
do
   ...
   $DATASTORE_CLIENT --max_execution_time 300 --query="
