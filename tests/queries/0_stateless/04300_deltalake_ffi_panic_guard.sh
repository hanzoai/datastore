...
# Regression test for https://github.com/ClickHouse/Datastore/issues/104509 (failure mode 2).
#
...
$DATASTORE_LOCAL --query "SELECT * FROM deltaLake('https://datastore-public-datasets.s3.amazonaws.com/delta_lake/hits/', '\0', 'x') SETTINGS allow_experimental_delta_kernel_rs = 1" 2>&1 \
