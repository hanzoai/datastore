...
CREATE TABLE byte_identical_r1(x UInt32) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00721/byte_identical', 'r1') ORDER BY x;
CREATE TABLE byte_identical_r2(x UInt32) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00721/byte_identical', 'r2') ORDER BY x;
