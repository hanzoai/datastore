...
CREATE TABLE t1 (x UInt32, s String) engine ReplicatedMergeTree('/datastore/{database}/t1', '1') order by tuple();
CREATE TABLE t2 (x UInt32, s String) engine ReplicatedMergeTree('/datastore/{database}/t2', '1') order by tuple();
