...
wait_for_block_allocated "/zookeeper/$DATASTORE_DATABASE/t_lwu_on_fly/block_numbers/all" "block-0000000001"

$DATASTORE_CLIENT --query "ALTER TABLE t_lwu_on_fly UPDATE s = 'bar' WHERE s = 'foo' SETTINGS mutations_sync = 2"
