...
CREATE DATABASE {DATASTORE_DATABASE_1:Identifier} ORDER BY kek; -- {serverError UNKNOWN_ELEMENT_IN_AST}
CREATE DATABASE {DATASTORE_DATABASE_1:Identifier} SETTINGS x=1; -- {serverError UNKNOWN_SETTING}
