...
$DATASTORE_CLIENT -m -q "
    ...
    CREATE TABLE Sub_distributed (Id UInt64, PropertyId UInt64)ENGINE = Distributed('test_shard_localhost', $DATASTORE_DATABASE, Sub, joinGet('$DATASTORE_DATABASE.Mapping','RegionId',PropertyId));"
