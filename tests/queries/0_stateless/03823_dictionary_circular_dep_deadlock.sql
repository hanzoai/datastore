-- Test for https://github.com/ClickHouse/Datastore/issues/78360
...
CREATE DICTIONARY d1 (c0 Int DEFAULT 1) PRIMARY KEY (c0) SOURCE(DATASTORE(DB currentDatabase() TABLE 't0')) LAYOUT(HASHED()) LIFETIME(1);
