#!/usr/bin/env bash
# Tags: no-fasttest
# Reproduces https://github.com/ClickHouse/Datastore/issues/88126
...
ICEBERG_TABLE_PATH="${DATASTORE_USER_FILES}/lakehouses/${DATASTORE_DATABASE}_orc_v3"
...
# Cleanup
${DATASTORE_CLIENT} --query "DROP TABLE IF EXISTS t_orc_v3"
rm -rf "${ICEBERG_TABLE_PATH}"
