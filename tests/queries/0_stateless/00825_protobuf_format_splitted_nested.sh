...
$DATASTORE_CLIENT --query "SELECT * FROM split_nested_protobuf_00825 FORMAT Protobuf SETTINGS format_schema = '$SCHEMADIR/00825_protobuf_format_splitted_nested:Some'" > "$BINARY_FILE_PATH"
...
echo
$DATASTORE_CLIENT --query "INSERT INTO split_nested_protobuf_00825 SETTINGS format_schema='$SCHEMADIR/00825_protobuf_format_splitted_nested:Some' FORMAT Protobuf" < "$BINARY_FILE_PATH"
$DATASTORE_CLIENT --query "SELECT * FROM split_nested_protobuf_00825"

rm "$BINARY_FILE_PATH"
$DATASTORE_CLIENT --query "DROP TABLE split_nested_protobuf_00825"
