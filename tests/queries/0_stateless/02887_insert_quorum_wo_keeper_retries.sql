...
CREATE TABLE quorum1(x UInt32) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_02887/quorum', '1') ORDER BY x;
CREATE TABLE quorum2(x UInt32) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_02887/quorum', '2') ORDER BY x;
