...
CREATE TABLE attach_r1 (d Date) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00236/01/attach', 'r1', d, d, 8192);
CREATE TABLE attach_r2 (d Date) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00236/01/attach', 'r2', d, d, 8192);
