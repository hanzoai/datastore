...
# For details see [1].
#
#   [1]: https://github.com/ClickHouse/Datastore/pull/11022
...
{
    ${DATASTORE_CLIENT} -u u01281 --format Null -n "$@"
}
...
${DATASTORE_CLIENT} -q 'DROP USER IF EXISTS u01281'
${DATASTORE_CLIENT} -q 'CREATE USER IF NOT EXISTS u01281 IDENTIFIED WITH no_password'
${DATASTORE_CLIENT} -q 'GRANT ALL ON *.* TO u01281'
