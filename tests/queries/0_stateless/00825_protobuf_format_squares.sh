...
$DATASTORE_CLIENT --query "SELECT * FROM squares_protobuf_00825 FORMAT Protobuf SETTINGS format_schema = '$SCHEMADIR/00825_protobuf_format_squares:NumberAndSquare'" > "$BINARY_FILE_PATH"
...
echo
$DATASTORE_CLIENT --query "INSERT INTO squares_protobuf_00825 SETTINGS format_schema='$SCHEMADIR/00825_protobuf_format_squares:NumberAndSquare' FORMAT Protobuf" < "$BINARY_FILE_PATH"
$DATASTORE_CLIENT --query "SELECT * FROM squares_protobuf_00825"

rm "$BINARY_FILE_PATH"
$DATASTORE_CLIENT --query "DROP TABLE squares_protobuf_00825"
