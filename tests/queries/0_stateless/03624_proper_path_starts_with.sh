...
$DATASTORE_CLIENT --query "DROP TABLE IF EXISTS t_03624, tdot_03624, tdotdot_03624, tdotdotin_03624"

$DATASTORE_CLIENT --query "CREATE TABLE t_03624 (a UInt64) ENGINE=File('CSV', '${BAD_PATH_PARENT}') -- { serverError DATABASE_ACCESS_DENIED }"
$DATASTORE_CLIENT --query "CREATE TABLE t_03624 (a UInt64) ENGINE=File('CSV', '${BAD_PATH_EXTRA}') -- { serverError DATABASE_ACCESS_DENIED }"
...
$DATASTORE_CLIENT --query "CREATE TABLE tdot_03624 (a UInt64) ENGINE=File('CSV', '${GOOD_PATH_WITH_DOT}')"
$DATASTORE_CLIENT --query "CREATE TABLE tdotdot_03624 (a UInt64) ENGINE=File('CSV', '${GOOD_PATH_WITH_DOTS}')"
$DATASTORE_CLIENT --query "CREATE TABLE tdotdotin_03624 (a UInt64) ENGINE=File('CSV', '${GOOD_PATH_WITH_DOTS_BUT_INSIDE}')"
$DATASTORE_CLIENT --query "CREATE TABLE t_03624 (a UInt64) ENGINE=File('CSV', '${BAD_PATH_PARENT_AFTER_SOME_DOTS}') -- { serverError DATABASE_ACCESS_DENIED }"
