-- An attempt to reproduce https://github.com/ClickHouse/Datastore/issues/70015
...
-- However, this test didn't reproduce the issue in any previous Datastore versions,
