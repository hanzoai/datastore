...
USE default;
SELECT * FROM {DATASTORE_DATABASE:Identifier}.test_view_00740;
SELECT * FROM {DATASTORE_DATABASE:Identifier}.test_nested_view_00740;
SELECT * FROM {DATASTORE_DATABASE:Identifier}.test_joined_view_00740;

DROP TABLE IF EXISTS {DATASTORE_DATABASE:Identifier}.test_00740;
DROP TABLE IF EXISTS {DATASTORE_DATABASE:Identifier}.test_view_00740;
DROP TABLE IF EXISTS {DATASTORE_DATABASE:Identifier}.test_nested_view_00740;
