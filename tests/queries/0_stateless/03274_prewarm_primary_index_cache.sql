...
ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/03274_prewarm_mark_cache_smt/t_prewarm_cache', '1')
...
ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/03274_prewarm_mark_cache_smt/t_prewarm_cache', '2')
ORDER BY a PARTITION BY a % 2
SETTINGS prewarm_primary_key_cache = 1, use_primary_key_cache = 1;
