...
# https://github.com/ClickHouse/Datastore/issues/79261
...
${DATASTORE_CLIENT} -q "SELECT '2263-01-01 00:00:00'::DateTime64(7) FORMAT Parquet" 2>&1 | grep -o 'VALUE_IS_OUT_OF_RANGE_OF_DATA_TYPE'

# Verify that values within range still work fine.
${DATASTORE_CLIENT} -q "SELECT '2200-01-01 00:00:00'::DateTime64(7) FORMAT Parquet" > /dev/null 2>&1 && echo "OK"
