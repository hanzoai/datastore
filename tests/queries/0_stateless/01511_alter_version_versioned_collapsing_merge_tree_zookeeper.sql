...
ENGINE ReplicatedVersionedCollapsingMergeTree('/datastore/' || currentDatabase() || '/test_01511/{shard}/t', '1_{replica}', sign, version)
ORDER BY key;
...
ENGINE ReplicatedVersionedCollapsingMergeTree('/datastore/' || currentDatabase() || '/test_01511/{shard}/t', '2_{replica}', sign, version)
ORDER BY key;
