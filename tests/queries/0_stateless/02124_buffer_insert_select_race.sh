...
#
#   [1]: https://github.com/ClickHouse/Datastore/issues/42740

CURDIR=$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)
# shellcheck source=../shell_config.sh
. "$CURDIR"/../shell_config.sh

$DATASTORE_CLIENT -q "DROP TABLE IF EXISTS t_buffer_string"
$DATASTORE_CLIENT -q "CREATE TABLE t_buffer_string(key String) ENGINE = Buffer('', '', 1, 1, 1, 1000000000000, 1000000000000, 1000000000000, 1000000000000)"
...
$DATASTORE_CLIENT -q "DROP TABLE t_buffer_string"
