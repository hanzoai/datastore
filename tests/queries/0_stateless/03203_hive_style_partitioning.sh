...
$DATASTORE_CLIENT -q "SELECT 'TESTING THE FILE HIVE PARTITIONING'"
...
$DATASTORE_CLIENT -q "SELECT 'TESTING THE URL PARTITIONING'"
...
$DATASTORE_CLIENT -q "SELECT 'TESTING THE S3 PARTITIONING'"
...
$DATASTORE_CLIENT -q "SELECT 'TESTING THE S3CLUSTER PARTITIONING'"
