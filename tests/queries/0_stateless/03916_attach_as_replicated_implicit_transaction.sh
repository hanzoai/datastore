...
${DATASTORE_CLIENT} --implicit_transaction=1 --async_insert=0 -q "INSERT INTO t_implicit_txn VALUES (1)"
${DATASTORE_CLIENT} --implicit_transaction=1 --async_insert=0 -q "INSERT INTO t_implicit_txn VALUES (2)"
