...
ATTACH TABLE {DATASTORE_DATABASE:Identifier}.mv_00508;

INSERT INTO {DATASTORE_DATABASE:Identifier}.src VALUES (3);

SELECT * FROM {DATASTORE_DATABASE:Identifier}.mv_00508 ORDER BY x;

-- Drop the MV and see if the data is still readable
DROP TABLE {DATASTORE_DATABASE:Identifier}.mv_00508;
SELECT * FROM {DATASTORE_DATABASE:Identifier}.dst ORDER BY x;

DROP TABLE {DATASTORE_DATABASE:Identifier}.src;
DROP TABLE {DATASTORE_DATABASE:Identifier}.dst;
