...
CREATE TABLE keeper_retries_r1(a UInt8) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test/02456_keeper_retries_during_insert', 'r1') ORDER BY tuple ();
CREATE TABLE keeper_retries_r2(a UInt8) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test/02456_keeper_retries_during_insert', 'r2') ORDER BY tuple();
