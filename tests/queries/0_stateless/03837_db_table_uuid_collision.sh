...
# Regression test for https://github.com/ClickHouse/Datastore/issues/98615
...
${DATASTORE_CLIENT} -q "DROP DATABASE IF EXISTS d_uuid_collision_98615"
${DATASTORE_CLIENT} -q "CREATE DATABASE d_uuid_collision_98615 UUID '10000000-0000-0000-0000-000000000001' ENGINE = Atomic"
...
${DATASTORE_CLIENT} -q "DROP DATABASE d_uuid_collision_98615"
