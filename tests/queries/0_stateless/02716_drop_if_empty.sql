...
DROP TABLE IF EXISTS {DATASTORE_DATABASE_1:Identifier}.data_02716_3;
...
CREATE TABLE {DATASTORE_DATABASE_1:Identifier}.data_02716_3 (v UInt64) ENGINE = MergeTree ORDER BY v;
...
DROP DATABASE IF EMPTY {DATASTORE_DATABASE_1:Identifier}; -- { serverError NOT_IMPLEMENTED }

SELECT count() FROM system.tables WHERE database = {DATASTORE_DATABASE_1:String};
