...
SELECT number, neighbor('Datastore', 0) FROM numbers(10);

SELECT number, neighbor('Datastore', 5) FROM numbers(10);
SELECT number, neighbor('Datastore', -5) FROM numbers(10);

SELECT number, neighbor('Datastore', 10) FROM numbers(10);
SELECT number, neighbor('Datastore', -10) FROM numbers(10);

SELECT number, neighbor('Datastore', 15) FROM numbers(10);
SELECT number, neighbor('Datastore', -15) FROM numbers(10);

SELECT number, neighbor('Datastore', 5, 'Hello') FROM numbers(10);
SELECT number, neighbor('Datastore', -5, 'World') FROM numbers(10);

SELECT number, neighbor('Datastore', 5, concat('Hello ', toString(number))) FROM numbers(10);
SELECT number, neighbor('Datastore', -5, concat('World ', toString(number))) FROM numbers(10);
