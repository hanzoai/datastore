...
${DATASTORE_CLIENT} -q "CREATE TABLE ghdata (data String) ENGINE = MergeTree ORDER BY tuple() SETTINGS index_granularity = 8192, index_granularity_bytes = '10Mi'"
...
${DATASTORE_CLIENT} --max_execution_time 300 -q "ALTER TABLE ghdata MODIFY column data JSON SETTINGS mutations_sync=1" --enable_json_type 1
