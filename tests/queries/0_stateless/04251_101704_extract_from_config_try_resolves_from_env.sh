...
# `datastore extract-from-config --try` must still resolve `from_env` substitutions
...
TEST_HTTP_PORT_101704=8123 TEST_HTTPS_PORT_101704=8443 TEST_NATIVE_PORT_101704=9000 \
    $DATASTORE_BINARY extract-from-config --config-file "$prefix.xml" --key=http_port --try
TEST_HTTP_PORT_101704=8123 TEST_HTTPS_PORT_101704=8443 TEST_NATIVE_PORT_101704=9000 \
    $DATASTORE_BINARY extract-from-config --config-file "$prefix.xml" --key=https_port --try
TEST_HTTP_PORT_101704=8123 TEST_HTTPS_PORT_101704=8443 TEST_NATIVE_PORT_101704=9000 \
    $DATASTORE_BINARY extract-from-config --config-file "$prefix.xml" --key=tcp_port --try
...
TEST_HTTP_PORT_101704=8123 \
    $DATASTORE_BINARY extract-from-config --config-file "$prefix.xml" --key=http_port
...
TEST_HTTP_PORT_101704=8123 \
    $DATASTORE_BINARY extract-from-config --config-file "${prefix}_bad_include.xml" --key=http_port --try
...
TEST_HTTP_PORT_101704=8123 TEST_HTTPS_PORT_101704=8443 TEST_NATIVE_PORT_101704=9000 \
    $DATASTORE_BINARY extract-from-config --config-file "$prefix.xml" --key='*_port' --try | sort
