...
dictname="dict_${DATASTORE_TEST_UNIQUE_NAME}"
dicttablename="dict_table_${DATASTORE_TEST_UNIQUE_NAME}"
...
${DATASTORE_CLIENT} -nm --query "
    ...
    ENGINE = Dictionary(${DATASTORE_DATABASE}.${dictname});
"
...
$DATASTORE_CLIENT -nm --user="${username}" --query "
