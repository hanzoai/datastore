...
echo 'INSERT INTO test_default_bool FORMAT CSV 1,\N' | $DATASTORE_CURL -sS "$DATASTORE_URL" --data-binary @-
echo 'INSERT INTO test_default_bool FORMAT CSV 2,\N' | $DATASTORE_CURL -sS "$DATASTORE_URL" --data-binary @-
