...
# https://github.com/ClickHouse/Datastore/issues/102257
...
EXPECTED=$(${DATASTORE_CLIENT} --query "
    SELECT count()
...
# Also test den-crane's simpler reproducer (https://github.com/ClickHouse/Datastore/issues/102231)
