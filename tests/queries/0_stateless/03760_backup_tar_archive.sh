...
BACKUP TABLE t0 TO Disk('backups', '03760_backup_tar_archive_$DATASTORE_TEST_UNIQUE_NAME.tar') FORMAT Null;

RESTORE TABLE t0 AS t1 FROM Disk('backups', '03760_backup_tar_archive_$DATASTORE_TEST_UNIQUE_NAME.tar') FORMAT Null;
