...
create dictionary db_01527_ranges.dict (key UInt64, shard UInt64) primary key key source(datastore(host '127.0.0.1' port tcpPort() table 'data' db 'db_01527_ranges' user 'default' password '')) lifetime(0) layout(hashed());
