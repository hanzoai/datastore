...
-- FIXME: BuiltIns_array_sort_Scalar is commented out: mixed-type arrays (int+string) with array_sort require Array(Dynamic) sorting which Datastore does not support
-- print '-- BuiltIns_array_sort_Scalar --';
-- let x=dynamic([ 1, 3, 2, "a", "c", "b" ]);
-- print a=array_sort_asc(x), b=array_sort_desc(x);
-- FIXME: BuiltIns_array_sort_Columnar is commented out: mixed-type arrays (int+string) with array_sort require Array(Dynamic) sorting which Datastore does not support
