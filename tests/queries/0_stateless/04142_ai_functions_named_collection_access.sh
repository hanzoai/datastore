...
user_name="${DATASTORE_DATABASE}_test_user_04142"
collection_name="${DATASTORE_DATABASE}_test_nc_04142"
...
$DATASTORE_CLIENT -q "GRANT NAMED COLLECTION ON $collection_name TO $user_name"
