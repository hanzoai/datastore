...
(
    u64 UInt64,
    i32 Int32
) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00836/indices_alter1', 'r1')
ORDER BY u64;
...
(
    u64 UInt64,
    i32 Int32
) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00836/indices_alter1', 'r2')
ORDER BY u64;
...
) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00836/indices_alter2', 'r1')
ORDER BY u64;
...
(
    ...
    INDEX idx1 u64 + i32 TYPE minmax GRANULARITY 10,
    INDEX idx2 u64 * i32 TYPE minmax GRANULARITY 10
) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00836/indices_alter2', 'r2')
ORDER BY u64;
