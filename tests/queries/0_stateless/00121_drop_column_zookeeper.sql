...
CREATE TABLE alter_00121 (d Date, x UInt8) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test/alter_00121/t1', 'r1', d, (d), 8192);
...
CREATE TABLE alter_00121 (d Date) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test/alter_00121/t2', 'r1', d, (d), 8192);
