...
cat ${CUR_DIR}/wasm/buffered_abi.wasm | ${DATASTORE_CLIENT} --query "INSERT INTO system.webassembly_modules (name, code) SELECT 'buffered_abi', code FROM input('code String') FORMAT RawBlob"
