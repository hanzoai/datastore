...
create table data_rep_02228 (key1 UInt32, sign Int8, s UInt64) engine = ReplicatedCollapsingMergeTree('/datastore/{database}', 'r1', sign) order by (key1) partition by key1 % 100 settings auto_statistics_types = '';
