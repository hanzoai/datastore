...
$DATASTORE_CLIENT --query="CREATE TABLE csv (d Date, u UInt8, str String) ENGINE = TinyLog"

INSERT_QUERY='$DATASTORE_CLIENT --query="INSERT INTO csv FORMAT CSVWithNames"'
...
$DATASTORE_CLIENT --query="SELECT * FROM csv ORDER BY ALL"
$DATASTORE_CLIENT --query="DROP TABLE IF EXISTS csv"
