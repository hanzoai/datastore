...
CREATE TABLE quorum1(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00732/quorum1', '1') ORDER BY x PARTITION BY y;
CREATE TABLE quorum2(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_00732/quorum1', '2') ORDER BY x PARTITION BY y;
