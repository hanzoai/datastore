...
$DATASTORE_CLIENT -q "DROP TABLE IF EXISTS json_each_row_nested"
$DATASTORE_CLIENT -q "CREATE TABLE json_each_row_nested (d1 UInt8, d2 String, n Nested (s String, i Int32) ) ENGINE = Memory"
...
| $DATASTORE_CLIENT --input_format_skip_unknown_fields=1 -q "INSERT INTO json_each_row_nested FORMAT JSONEachRow"

$DATASTORE_CLIENT --max_threads=1 -q "SELECT * FROM json_each_row_nested"
