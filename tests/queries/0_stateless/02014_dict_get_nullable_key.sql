...
CREATE DICTIONARY test_dictionary_non_nullable (id UInt64, value String) PRIMARY KEY id LAYOUT(DIRECT()) SOURCE(DATASTORE(TABLE 'dictionary_non_nullable_source_table'));
...
CREATE DICTIONARY test_dictionary_nullable (id UInt64, value Nullable(String)) PRIMARY KEY id LAYOUT(DIRECT()) SOURCE(DATASTORE(TABLE 'dictionary_nullable_source_table'));
