...
) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00988/alter_constraints', 'r1') ORDER BY (a);
...
(
    ...
    b UInt32,
    CONSTRAINT a_constraint CHECK a < 10
) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_00988/alter_constraints', 'r2') ORDER BY (a);
