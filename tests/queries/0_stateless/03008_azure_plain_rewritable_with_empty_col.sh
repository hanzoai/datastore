...
${DATASTORE_CLIENT} --query "drop table if exists test_azure_mt"
...
${DATASTORE_CLIENT} --query "optimize table test_azure_mt final"
...
${DATASTORE_CLIENT} --query "drop table if exists test_azure_mt sync"
