...
cat ${CUR_DIR}/wasm/exceptions.wasm | ${DATASTORE_CLIENT} --query "INSERT INTO system.webassembly_modules (name, code) SELECT 'wasm_exceptions', code FROM input('code String') FORMAT RawBlob"
