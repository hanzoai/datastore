...
ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_01213/table_for_rename_pk1', '1')
PARTITION BY date
...
ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/test_01213/table_for_rename_pk2', '1')
PARTITION BY date
