...
SELECT * FROM T1 FULL JOIN {DATASTORE_DATABASE:Identifier}.T2 ON T1.A = T2.A ORDER BY ALL
FORMAT PrettyCompactMonoBlock;

SELECT * FROM {DATASTORE_DATABASE:Identifier}.T1 FULL JOIN T2 ON T1.A = T2.A ORDER BY ALL
FORMAT PrettyCompactMonoBlock;
