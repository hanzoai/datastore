...
CREATE TABLE r1 (x String) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/r', 'r1') ORDER BY x;
CREATE TABLE r2 (x String) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/r', 'r2') ORDER BY x;
