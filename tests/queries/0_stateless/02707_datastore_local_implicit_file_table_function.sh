...
$DATASTORE_LOCAL -q "insert into function file('$dir/tmp_numbers_1.csv') select * from numbers(1, 10)"
$DATASTORE_LOCAL -q "insert into function file('$dir/tmp_numbers_2.csv') select * from numbers(11, 10)"
$DATASTORE_LOCAL -q "insert into function file('$dir/tmp_numbers_30.csv') select * from numbers(21, 10)"
...
echo "explicit:"
$DATASTORE_LOCAL -q "SELECT COUNT(*) FROM file('${dir}/tmp.csv')"
echo "implicit:"
$DATASTORE_LOCAL -q "SELECT COUNT(*) FROM \"${dir}/tmp.csv\""
