...
"
$DATASTORE_CLIENT -q "SYSTEM STOP MERGES t_concurrent_removal"
$DATASTORE_CLIENT -q "INSERT INTO t_concurrent_removal VALUES (1)"
...
$DATASTORE_CLIENT -q "INSERT INTO t_concurrent_removal VALUES (2)"
...
$DATASTORE_CLIENT -q "DROP TABLE t_concurrent_removal"
...
$DATASTORE_CLIENT -q "
    ...
    CREATE TABLE t_noconflict_removal (n Int64)
        ...
        SETTINGS old_parts_lifetime=3600;
"
$DATASTORE_CLIENT -q "SYSTEM STOP MERGES t_noconflict_removal"
$DATASTORE_CLIENT -q "INSERT INTO t_noconflict_removal VALUES (1)"   # partition 1
$DATASTORE_CLIENT -q "INSERT INTO t_noconflict_removal VALUES (2)"   # partition 0
...
$DATASTORE_CLIENT -q "DROP TABLE t_noconflict_removal"
