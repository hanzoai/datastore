...
$DATASTORE_CLIENT --query "
    ...
    CREATE TABLE t_mutations_counters_rename (a UInt64, b UInt64) ENGINE = ReplicatedMergeTree('/datastore/tables/{database}/t_mutations_counters_rename', '1') ORDER BY a;
