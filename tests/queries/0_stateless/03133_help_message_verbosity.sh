...
$DATASTORE_CLIENT --help > "help_msg_$PID.txt"
$DATASTORE_CLIENT --help --verbose > "verbose_help_msg_$PID.txt"
...
# The same for datastore local
$DATASTORE_LOCAL --help > "help_msg_$PID.txt"
$DATASTORE_LOCAL --help --verbose > "verbose_help_msg_$PID.txt"
