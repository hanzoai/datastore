...
# Regression test for https://github.com/ClickHouse/Datastore/issues/93278
...
${DATASTORE_CLIENT} --query "DROP VIEW IF EXISTS ${TABLE}_mv"
...
${DATASTORE_CLIENT} --query "SELECT * FROM ${TABLE}_mv"

# Insert data and verify it's readable through the view.
${DATASTORE_CLIENT} --query "INSERT INTO ${TABLE}_mv VALUES (42)" --allow_insert_into_iceberg 1
${DATASTORE_CLIENT} --query "SELECT c0 FROM ${TABLE}_mv"
