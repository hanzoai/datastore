...
set min_bytes_to_use_direct_io = 0; -- min_bytes_to_use_direct_io > 0 is broken and leads to unexpected results, https://github.com/ClickHouse/Datastore/issues/65690

create table X (id Int32, x_a String, x_b Nullable(Int32)) engine ReplicatedMergeTree('/datastore/{database}/X', '1') order by tuple();
create table Y (id Int32, y_a String, y_b Nullable(String)) engine ReplicatedMergeTree('/datastore/{database}/Y', '1') order by tuple();
