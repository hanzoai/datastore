...
CREATE TABLE quorum1(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_02377/quorum', '1') ORDER BY x PARTITION BY y;
CREATE TABLE quorum2(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_02377/quorum', '2') ORDER BY x PARTITION BY y;
...
CREATE TABLE quorum1(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_02377/quorum1', '1') ORDER BY x PARTITION BY y;
CREATE TABLE quorum2(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_02377/quorum1', '2') ORDER BY x PARTITION BY y;
CREATE TABLE quorum3(x UInt32, y Date) ENGINE ReplicatedMergeTree('/datastore/tables/{database}/test_02377/quorum1', '3') ORDER BY x PARTITION BY y;
