...
# https://github.com/ClickHouse/Datastore/issues/6497
...
$DATASTORE_CLIENT --query "SELECT * FROM nested_optional_protobuf_00825 FORMAT Protobuf SETTINGS format_schema = '$SCHEMADIR/00825_protobuf_format_nested_optional:Message'" > "$BINARY_FILE_PATH"
...
echo
$DATASTORE_CLIENT --query "INSERT INTO nested_optional_protobuf_00825 SETTINGS format_schema='$SCHEMADIR/00825_protobuf_format_nested_optional:Message' FORMAT Protobuf" < "$BINARY_FILE_PATH"
$DATASTORE_CLIENT --query "SELECT * FROM nested_optional_protobuf_00825"

rm "$BINARY_FILE_PATH"
$DATASTORE_CLIENT --query "DROP TABLE nested_optional_protobuf_00825"
