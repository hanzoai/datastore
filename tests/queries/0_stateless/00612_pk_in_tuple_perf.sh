...
$DATASTORE_CLIENT --query "$query FORMAT JSON" | grep "rows_read"
...
$DATASTORE_CLIENT --query "DROP TABLE pk_in_tuple_perf"
$DATASTORE_CLIENT --query "DROP TABLE pk_in_tuple_perf_non_const"
