...
cat ${CUR_DIR}/wasm/test_v128.wasm | ${DATASTORE_CLIENT} --query "INSERT INTO system.webassembly_modules (name, code) SELECT 'test_v128', code FROM input('code String') FORMAT RawBlob"
