...
query_id_base=$($DATASTORE_CLIENT -q "select rand64()");
$DATASTORE_CLIENT --query_id=${query_id_base}_1 -q "select json.s from test format Null settings max_result_bytes=0"
$DATASTORE_CLIENT --query_id=${query_id_base}_2 -q "select tuple.s from test format Null settings max_result_bytes=0"
