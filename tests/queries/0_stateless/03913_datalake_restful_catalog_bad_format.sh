...
NEW_DB_NAME="${DATASTORE_DATABASE}_03913_DATALAKE"

$DATASTORE_CLIENT -q "DROP DATABASE IF EXISTS ${NEW_DB_NAME};"
$DATASTORE_CLIENT -q "
...
$DATASTORE_CLIENT -q "SELECT count() FROM system.databases WHERE name = '${NEW_DB_NAME}';"
...
NEW_DB_FORBIDDEN="${DATASTORE_DATABASE}_03913_FORBIDDEN"

$DATASTORE_CLIENT -q "DROP DATABASE IF EXISTS ${NEW_DB_FORBIDDEN};"
$DATASTORE_CLIENT -q "
SET allow_experimental_database_iceberg = 1;
...
$DATASTORE_CLIENT -q "SELECT count() FROM system.databases WHERE name = '${NEW_DB_FORBIDDEN}';"
