...
CREATE DICTIONARY dict_flat_simple (v0 UInt16, v1 UInt16, v2 UInt16) PRIMARY KEY v0 SOURCE(DATASTORE(TABLE 'dict_data')) LIFETIME(0) LAYOUT(flat());
...
CREATE DICTIONARY dict_hashed_simple_Decimal128 (v3 Decimal128(10), v1 UInt16, v2 Float32) PRIMARY KEY v3 SOURCE(DATASTORE(TABLE 'dict_data')) LIFETIME(0) LAYOUT(hashed());
...
CREATE DICTIONARY dict_hashed_simple_Float32 (v2 Float32, v3 Decimal128(10), v4 String) PRIMARY KEY v2 SOURCE(DATASTORE(TABLE 'dict_data')) LIFETIME(0) LAYOUT(hashed());
...
CREATE DICTIONARY dict_hashed_simple_String (v4 String, v3 Decimal128(10), v2 Float32) PRIMARY KEY v4 SOURCE(DATASTORE(TABLE 'dict_data')) LIFETIME(0) LAYOUT(hashed());
...
CREATE DICTIONARY dict_hashed_simple_auto_convert (v0 UInt16, v1 Int16, v2 UInt16) PRIMARY KEY v0,v1 SOURCE(DATASTORE(TABLE 'dict_data')) LIFETIME(0) LAYOUT(hashed());
