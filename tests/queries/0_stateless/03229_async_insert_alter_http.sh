...
${DATASTORE_CURL} -sS "$url" -d "INSERT INTO t_async_insert_alter VALUES (42, 24)"
...
${DATASTORE_CURL} -sS "$url" -d "INSERT INTO t_async_insert_alter VALUES (43, 34, 55)"
...
${DATASTORE_CURL} -sS "$url" -d "INSERT INTO t_async_insert_alter VALUES ('100', '200', '300')"
