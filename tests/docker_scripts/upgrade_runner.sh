...
git clone https://github.com/ClickHouse/Datastore.git --no-tags --progress --branch=$previous_release_tag --no-recurse-submodules --depth=1 previous_release_repository
...
datastore-client --query="SELECT 'Server version: ', version()"
...
# FIXME https://github.com/ClickHouse/Datastore/issues/38643 ("Unknown index: idx.")
...
# FIXME https://github.com/ClickHouse/Datastore/issues/39197 ("Missing columns: 'v3' while processing query: 'v3, k, v1, v2, p'")
# FIXME https://github.com/ClickHouse/Datastore/issues/39174 - bad mutation does not indicate backward incompatibility:
