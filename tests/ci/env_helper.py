...
GITHUB_UPSTREAM_REPOSITORY = os.getenv(
    "GITHUB_UPSTREAM_REPOSITORY", "hanzoai/datastore"
)
...
S3_BUILDS_BUCKET_PUBLIC = "hanzo-datastore-builds"
S3_TEST_REPORTS_BUCKET = os.getenv("S3_TEST_REPORTS_BUCKET", "hanzo-datastore-test-reports")
