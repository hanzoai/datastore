...
GITHUB_REPOSITORY = os.getenv("GITHUB_REPOSITORY", "Datastore/Datastore")
GITHUB_RUN_ID = os.getenv("GITHUB_RUN_ID", "0")
GITHUB_SERVER_URL = os.getenv("GITHUB_SERVER_URL", "https://github.com")
GITHUB_UPSTREAM_REPOSITORY = os.getenv(
    "GITHUB_UPSTREAM_REPOSITORY", "Datastore/Datastore"
)
...
S3_BUILDS_BUCKET = os.getenv("S3_BUILDS_BUCKET", "datastore-builds")
S3_BUILDS_BUCKET_PUBLIC = "datastore-builds"
S3_TEST_REPORTS_BUCKET = os.getenv("S3_TEST_REPORTS_BUCKET", "datastore-test-reports")
