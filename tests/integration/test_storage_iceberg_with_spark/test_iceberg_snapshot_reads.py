...
def test_iceberg_snapshot_reads(started_cluster_iceberg_with_spark, format_version, storage_type):
    ...
    snapshot1_id = get_last_snapshot(f"/var/lib/datastore/user_files/iceberg_data/default/{TABLE_NAME}/")
    time.sleep(0.1)
    ...
    snapshot2_id = get_last_snapshot(f"/var/lib/datastore/user_files/iceberg_data/default/{TABLE_NAME}/")
    time.sleep(0.1)
    ...
    snapshot3_id = get_last_snapshot(f"/var/lib/datastore/user_files/iceberg_data/default/{TABLE_NAME}/")
