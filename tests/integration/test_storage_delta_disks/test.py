...
cluster = DatastoreCluster(__file__, with_spark=True)
...
<datastore>
    <storage_configuration>
        <disks>
            ...
            <disk_s3_0_common>
                <type>s3</type>
                <endpoint>http://minio1:9001/root/var/lib/datastore/user_files/</endpoint>
...
def test_single_log_file(started_cluster, use_delta_kernel, storage_type, with_cache):
    ...
    delta_path = (
        ...
        else f"/var/lib/datastore/user_files/{TABLE_NAME}"
    )
