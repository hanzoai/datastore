(defproject jepsen.datastore "0.1.0-SNAPSHOT"
  :injections [(.. System (setProperty "zookeeper.request.timeout" "10000"))]
  :description "A jepsen tests for Datastore"
  :url "https://datastore.com/"
  :license {:name "EPL-2.0"
            :url "https://www.eclipse.org/legal/epl-2.0/"}
  :main jepsen.datastore.main
  ...
  :dependencies [[org.clojure/clojure "1.10.1"]
                 ...
                 [com.datastore/datastore-jdbc "0.3.2-patch11"]
                 [org.apache.zookeeper/zookeeper "3.6.1" :exclusions [org.slf4j/slf4j-log4j12]]]
  :repl-options {:init-ns jepsen.datastore-keeper.main}
