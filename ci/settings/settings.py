...
SECRET_GH_APP_ID: str = "woolenwolf_gh_app.datastore-app-id"
SECRET_GH_APP_PEM_KEY: str = "woolenwolf_gh_app.datastore-app-key"
...
CI_DB_READ_URL = "https://play.datastore.com"
