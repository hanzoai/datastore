...
datastore-client_18.14.9_all.deb datastore-common-static_18.14.9_amd64.deb datastore-server_18.14.9_all.deb
$ docker run --volume=$HOME/someclickhouse:/package_folder --volume=$HOME/test_output:/test_output datastore/stress-test
Selecting previously unselected package datastore-common-static.
(Reading database ... 14442 files and directories currently installed.)
...
Start datastore-server service: Path to data directory in /etc/datastore-server/config.xml: /var/lib/datastore/
DONE
...
2018-10-22 13:49:16,171 Checking Datastore still alive
Still alive
2018-10-22 13:49:16,195 Stress is ok
2018-10-22 13:49:16,195 Copying server log files
$ ls $HOME/test_result
datastore-server.err.log datastore-server.log.0.zst stderr.log stress_test_run_0.txt  stress_test_run_11.txt stress_test_run_13.txt
stress_test_run_15.txt stress_test_run_2.txt stress_test_run_4.txt stress_test_run_6.txt stress_test_run_8.txt datastore-server.log
