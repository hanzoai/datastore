...
2. Prepare a commit SHA and parameters
   ...
   - `base_url`: URL-encoded base URL to CI reports (encoded `https://s3.amazonaws.com/datastore-test-reports` becomes `https%3A%2F%2Fs3.amazonaws.com%2Fdatastore-test-reports`)
...
REF=master&sha=YOUR_COMMIT_SHA&base_url=https%3A%2F%2Fs3.amazonaws.com%2Fdatastore-test-reports&name_0=MasterCI
```
...
open -a "Google Chrome" --args \
  ...
  "file:///ABSOLUTE_PATH_TO_REPO/ci/praktika/json.html?REF=master&sha=YOUR_COMMIT_SHA&base_url=https%3A%2F%2Fs3.amazonaws.com%2Fdatastore-test-reports&name_0=MasterCI"
```
...
```
Please start Chrome with disabled CORS and open ./ci/praktika/json.html file with params:
REF=master&sha=59d18f406d9ef99bbf400184fd0ba47a84381bec&base_url=https%3A%2F%2Fs3.amazonaws.com%2Fdatastore-test-reports&name_0=MasterCI
```
