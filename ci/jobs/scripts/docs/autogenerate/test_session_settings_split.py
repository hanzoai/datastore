    ...
    with tempfile.TemporaryDirectory() as temp:
        ...
        for path, content in by_path.items():
            if path.suffix == ".mdx" and path != dest:
                ...
                assert content.index(mod.AUTOGENERATED_START) < content.index(
                    mod.SESSION_SETTINGS_MARKER
                ) < content.index(mod.AUTOGENERATED_END)
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            for path, page in by_path.items():
                if path.suffix == ".mdx" and path != dest:
                    ...
                    assert page.index(mod.AUTOGENERATED_START) < page.index(
                        family["marker"]
                    ) < page.index(mod.AUTOGENERATED_END)
