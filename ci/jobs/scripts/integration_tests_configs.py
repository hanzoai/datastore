...
IMAGES_ENV = {
    "hanzoai/datastore-dotnet-client": "DOCKER_DOTNET_CLIENT_TAG",
    "hanzoai/datastore-integration-helper": "DOCKER_HELPER_TAG",
    "hanzoai/datastore-integration-test": "DOCKER_BASE_TAG",
    "hanzoai/datastore-kerberos-kdc": "DOCKER_KERBEROS_KDC_TAG",
    "hanzoai/datastore-test-mysql80": "DOCKER_TEST_MYSQL80_TAG",
    "hanzoai/datastore-test-mysql57": "DOCKER_TEST_MYSQL57_TAG",
    "hanzoai/datastore-mysql-golang-client": "DOCKER_MYSQL_GOLANG_CLIENT_TAG",
    "hanzoai/datastore-mysql-java-client": "DOCKER_MYSQL_JAVA_CLIENT_TAG",
    "hanzoai/datastore-mysql-js-client": "DOCKER_MYSQL_JS_CLIENT_TAG",
    "hanzoai/datastore-arrowflight-server-test": "DOCKER_ARROWFLIGHT_SERVER_TAG",
    "hanzoai/datastore-mysql-php-client": "DOCKER_MYSQL_PHP_CLIENT_TAG",
    "hanzoai/datastore-nginx-dav": "DOCKER_NGINX_DAV_TAG",
    "hanzoai/datastore-postgresql-java-client": "DOCKER_POSTGRESQL_JAVA_CLIENT_TAG",
    "hanzoai/datastore-python-bottle": "DOCKER_PYTHON_BOTTLE_TAG",
    "hanzoai/datastore-integration-test-with-unity-catalog": "DOCKER_BASE_WITH_UNITY_CATALOG_TAG",
    "hanzoai/datastore-integration-test-with-hms": "DOCKER_BASE_WITH_HMS_TAG",
    "hanzoai/datastore-mysql_dotnet_client": "DOCKER_MYSQL_DOTNET_CLIENT_TAG",
    "hanzoai/datastore-s3-proxy": "DOCKER_S3_PROXY_TAG",
}
