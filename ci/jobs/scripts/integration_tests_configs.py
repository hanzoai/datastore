...
TEST_CONFIGS = [
    ...
    TC(
        ...
        False,
        "starts a Spark JVM + multi-node Datastore cluster per module fixture",
        dist_each_sequential=True,
    ),
    TC(
...
test_dictionaries_all_layouts_separate_sources/test_datastore_remote.py	549938
test_dictionaries_all_layouts_separate_sources/test_datastore_local.py	547214
...
test_datastore_server_wait_server_pool/test.py	77474
