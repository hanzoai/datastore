...
class Labels:
    ...
    PR_CI = "pr-ci"
    # Marks the nightly docs-autogen bot PR; the docs check exempts it from the
    # generated-region and read-only-copy guards (see docs_job_mintlify.py).
    PR_AUTOGENERATED_DOCS = "pr-autogenerated-docs"
