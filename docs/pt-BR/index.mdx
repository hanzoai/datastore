    ...
    return (
        ...
        >
            <div>
                ...
                <span className="block text-[#6b7280] dark:text-[#a1a1aa] mt-1 text-sm font-normal leading-normal">100+ integrações to connect the tools and services that you love with ClickHouse.</span>
            </div>
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "guia de início rápido", href: "/get-started/quickstarts/home" },
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Referência SQL", href: "/reference/statements" },
        { label: "Configurações", href: "/reference/settings/index" },
        { label: "Funções", href: "/reference/functions/regular-functions/overview" },
        { label: "Motores", href: "/reference/engines/engines" },
        { label: "Tabelas do sistema", href: "/reference/system-tables" },
        { label: "Formatos", href: "/reference/formats/index" },
        { label: "Tipos de dados", href: "/reference/data-types/index" }
    ]}
        />
        ...
        { label: "Operator do Kubernetes", href: "/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Analytics em tempo real" galaxyEvent="docs.home.real-time-analytics" description="Ofereça insights instantâneos e dashboards em escala. Analise bilhões de linhas em tempo real com resultados em milissegundos." href="/pt-BR/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Observabilidade" galaxyEvent="docs.home.observability" description="Armazene e consulte logs, métricas e traces em escala usando o ClickStack, a stack de observabilidade open source com tecnologia ClickHouse." href="/pt-BR/clickstack/overview" showArrow />

        <HeroCard title="Armazenamento de dados" galaxyEvent="docs.home.data-warehousing" description="Analise e explore dados instantaneamente para obter insights e criar aplicativos. Escale mais rápido descarregando workloads intensivas." href="/pt-BR/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Analytics agêntica" galaxyEvent="docs.home.agentic-analytics" description="Permita que agentes de IA consultem diretamente seus dados em tempo real para gerar insights conversacionais e visualizações instantâneas" href="/pt-BR/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. Como fazer a ingestão de dados de fontes comuns com o mínimo de esforço", href: "/integrations" },
              { label: "2. Boas práticas para organizar dados para analytics e crescimento", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Formas de consultar grandes conjuntos de dados em tempo real", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. Como criar dashboards, alertas e funcionalidades orientadas a eventos sobre a mesma plataforma", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. Dicas para manter os custos baixos sem perder desempenho", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" galaxyEvent="docs.home.clickstack" description="A stack de observabilidade tudo em um com tecnologia ClickHouse, que oferece consultas extremamente rápidas e agregações poderosas em logs, métricas, traces, replays de sessão e erros." href="/pt-BR/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Operator do Kubernetes" galaxyEvent="docs.home.kubernetes-operator" description="Automatiza a implantação, configuração e gerenciamento de clusters ClickHouse e ClickHouse Keeper no Kubernetes." href="/pt-BR/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" galaxyEvent="docs.home.chdb" description="Um banco de dados rápido, confiável e escalável que roda no próprio processo. Experimente o poder do ClickHouse no próprio processo." href="/pt-BR/chdb/index" showArrow />
        </div>
      </div>
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Consulte a documentação do ClickHouse diretamente nas suas ferramentas de IA usando o Model Context Protocol.</p>

        <div className="mt-6">
          <Tabs>
            <Tab title="Claude Code" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claudecode-color.svg">
              <p className="mb-2 text-[#9ca3af] text-[13px]">Execute no terminal:</p>
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">Adicione skills do ClickHouse ao seu agente de codificação</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Instale as skills do ClickHouse para dar ao seu agente conhecimento especializado em ClickHouse e melhores práticas.</p>
