...
- https://datastore.com/docs/en/sql-reference/statements/grant/
- https://datastore.com/docs/en/sql-reference/statements/revoke/
- https://datastore.com/docs/en/sql-reference/statements/select/join/
