...
8. Además, puede proporcionar una expresión `PARTITION BY <expr>` personalizada para controlar el particionado de la [tabla de ClickHouse de destino](/es/partitions).
