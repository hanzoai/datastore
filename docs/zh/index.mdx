  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <h1 className="block text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
        开始基于 <HighlightedClickHouse /> 进行构建
      </h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "样本数据集", href: "/get-started/sample-datasets/index" },
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="实时分析" galaxyEvent="docs.home.real-time-analytics" description="大规模交付即时洞察和仪表盘。实时分析数十亿行数据，结果可在毫秒内返回。" href="/zh/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="可观测性" galaxyEvent="docs.home.observability" description="借助 ClickStack（由 ClickHouse 提供支持的开源可观测性技术栈），大规模存储和查询日志、指标和链路追踪。" href="/zh/clickstack/overview" showArrow />

        <HeroCard title="数据仓储" galaxyEvent="docs.home.data-warehousing" description="即时分析和探索数据，获取洞察并构建应用。通过卸载繁重工作负载，实现更快扩展。" href="/zh/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="智能体分析" galaxyEvent="docs.home.agentic-analytics" description="让 AI 智能体直接查询实时数据，提供即时的对话式洞察和可视化" href="/zh/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. 如何以最低成本从常见来源摄取数据", href: "/integrations" },
              { label: "2. 面向分析和增长场景组织数据的最佳实践", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. 实时查询大型数据集的方法", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. 如何在此基础上构建仪表盘、告警和事件驱动功能", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. 在保持高性能的同时降低成本的技巧", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" galaxyEvent="docs.home.clickstack" description="由 ClickHouse 驱动的一体化可观测性技术栈，提供针对日志、指标、链路追踪、会话回放和错误的闪电般快速查询与强大聚合能力。" href="/zh/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard filename="thumbnail-postgres-light.webp" title="Managed Postgres" galaxyEvent="docs.home.managed-postgres" description="快速、可扩展、企业级的 Postgres 服务，与 ClickHouse 原生集成。轻松结合使用 Postgres 处理事务，用 ClickHouse 进行分析。" href="/zh/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" galaxyEvent="docs.home.kubernetes-operator" description="在 Kubernetes 上自动部署、配置和管理 ClickHouse 与 ClickHouse Keeper 集群。" href="/zh/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" galaxyEvent="docs.home.chdb" description="快速、可靠且可扩展的进程内数据库。体验以进程内方式运行的 ClickHouse 的强大能力。" href="/zh/chdb/index" showArrow />
        </div>
      </div>
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-0">设置文档 MCP 服务器</h2>
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">使用 Model Context Protocol，直接通过 AI 工具查询 ClickHouse 文档。</p>
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">为您的编程智能体添加 ClickHouse 技能</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">安装 ClickHouse 技能，为您的智能体提供专业的 ClickHouse 知识和最佳实践。</p>
