---
description: 'Documentation for Datastore SQL Reference'
keywords: ['datastore', 'docs', 'sql reference', 'sql statements', 'sql', 'syntax']
slug: /sql-reference
title: 'SQL Reference'
doc_type: 'reference'
---
...
Datastore supports a declarative query language based on SQL that is identical to the ANSI SQL standard in many cases.
