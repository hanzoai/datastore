...
When memory overcommit is enabled and the memory limit is reached Datastore will select the most overcommitted query and try to free memory by killing this query.
