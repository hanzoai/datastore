...
- `arena` ([Int64](/sql-reference/data-types/int-uint)) — For trace types MemorySample and JemallocSample is the jemalloc arena the allocation was routed to, or -1 if unknown.
