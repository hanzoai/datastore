...
Contains information about setting changes in previous Datastore versions.

## Columns {#columns}

<!--AUTOGENERATED_START-->
- `type` ([Enum8('Session' = 0, 'MergeTree' = 1)](/sql-reference/data-types/enum)) — The group of settings (Session, MergeTree...)
- `version` ([String](/sql-reference/data-types/string)) — The Datastore server version.
- `changes` ([Array(Tuple(name String, previous_value String, new_value String, reason String))](/sql-reference/data-types/array)) — The list of changes in settings which changed the behaviour of Datastore.
<!--AUTOGENERATED_END-->
