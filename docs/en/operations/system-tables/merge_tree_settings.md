...
- `tier` ([Enum8('Production' = 0, 'Obsolete' = 4, 'Experimental' = 8, 'Beta' = 12)](/sql-reference/data-types/enum)) — Support level for this feature. Datastore features are organized in tiers, varying depending on the current status of their
