...
- `host` ([String](/sql-reference/data-types/string)) — The hostname/IP of the ZooKeeper node that Datastore connected to or disconnected from.
- `port` ([UInt16](/sql-reference/data-types/int-uint)) — The port of the ZooKeeper node that Datastore connected to or disconnected from.
- `index` ([UInt8](/sql-reference/data-types/int-uint)) — The index of the ZooKeeper node that Datastore connected to or disconnected from. The index is from ZooKeeper config.
...
- `enabled_feature_flags` ([Array(Enum16('FILTERED_LIST' = 0, 'MULTI_READ' = 1, 'CHECK_NOT_EXISTS' = 2, 'CREATE_IF_NOT_EXISTS' = 3, 'REMOVE_RECURSIVE' = 4, 'MULTI_WATCHES' = 5, 'CHECK_STAT' = 6, 'PERSISTENT_WATCHES' = 7, 'CREATE_WITH_STATS' = 8, 'TRY_REMOVE' = 9, 'LIST_WITH_STAT_AND_DATA' = 10, 'GET_CHILDREN_RECURSIVE' = 11))](/sql-reference/data-types/array)) — Feature flags which are enabled. Only applicable to Datastore Keeper.
