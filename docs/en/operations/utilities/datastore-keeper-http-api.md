---
description: 'Documentation for the Datastore Keeper HTTP API and embedded dashboard'
sidebar_label: 'Keeper HTTP API'
sidebar_position: 70
slug: /operations/utilities/datastore-keeper-http-api
title: 'Keeper HTTP API and Dashboard'
doc_type: 'reference'
---

Datastore Keeper provides an HTTP API and embedded web dashboard for monitoring, health checks, and storage management. 
...
- **Methods**: GET, POST
- **Description**: Executes Four-Letter Word commands or Datastore Keeper Client CLI commands
