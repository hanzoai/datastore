...
<html> <head> <title>Search phrases</title> </head>
 <body>
  <table border="1"> <caption>Search phrases</caption>
    ...
    <tr> <td>datastore</td> <td>1655</td> </tr>
...
SETTINGS
 ...
 format_template_resultset_format='|Datastore Formats|\n|---|\n${data}\n'
```
